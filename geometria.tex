...
\Cpp{\detokenize{geometria/basico/line_segment_intersection}}
\divisor

\subsubsection{Pontos em lattice}
\Cpp{\detokenize{geometria/aleatorio/pts_in_lattice}}
\divisor
...
\Cpp{\detokenize{geometria/basico/point_on_segment}}
\divisor
